...
{
    public partial class frmRpKetQuaTongNNDauRaTNNN : Form
    {
        ...
        public frmRpKetQuaTongNNDauRaTNNN(int LocationID, string unit)
        {
            InitializeComponent();
            InitializeService();
        ...
        private float KetQuaNghe(int contestantShiftID)
        {
            ...
            //            if (aw != null)
            //            {
            //                if (aw.IsCorrect && aw.SUBQUESTION.QUESTION.Type == 1)
            //                {
            //                    //aw.SUBQUESTION.QUESTION.Audio != null
