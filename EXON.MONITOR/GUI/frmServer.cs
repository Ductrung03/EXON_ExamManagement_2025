...
namespace EXON.MONITOR.GUI
{
    ...
    {   
        ...
        private void InitializeControl()
        {
            ...
            setFullScreen();
            staff = _StaffService.GetById(supervisorID);
        ...
        public void handelPannelDiagram()
        {
          TabPage tabroom = new TabPage();
            ...
            DIVISION_SHIFTS divisionShift = _DivisionShiftService.GetById(divisionShiftID);
            SHIFT shift = _ShiftService.GetById(shiftID);
            tabroom.Name = divisionShift.RoomTestID.ToString();
            tabroom.Text = "Phòng: " + divisionShift.ROOMTEST.RoomTestName;
            Control.ucServer ucserver = new Control.ucServer(divisionShift, shift);
        ...
        private void mItemPrintChangeAws_Click(object sender, EventArgs e)
        {
            try
            {
                _DivisionShiftService = new DivisionShiftService();
                ...
                Report.FrmRpLogChangeAws changeaws = new FrmRpLogChangeAws(ds);
        ...
        {
            frmDoiMay frm = new frmDoiMay(divisionShiftID);
            frm.ShowDialog();
        }

        private void mItemPrintViolations_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            frmChangeHeightToDisplay frm = new frmChangeHeightToDisplay();
            frm.ShowDialog();
        }
    }
}
