...
namespace EXON.Common
{
    public static class Constant
    {
        ...
        //Trạng thái đổi máy thí sinh
        public static int STATUS_CHANGE_COMPUTER = 3014;
        ...
        public static string pathTemp = Application.StartupPath + "\\Template\\WritingAnswer.docx";
        public static string pathTempPrintTest = Application.StartupPath + "\\Template\\PrintTest.docx";
        public static string pathTempQuestionTable = Application.StartupPath + "\\Template\\QuestionTable.docx";
        public static string pathTempThongKe = Application.StartupPath + "\\Template\\ThongKe.docx";
        public static string pathTempPrintResult = Application.StartupPath + "\\Template\\PrintResult.docx";
        public static string pathTempPrintResultN = Application.StartupPath + "\\Template\\PrintResultNull.docx";
        public static string pathTempSpeaking = Application.StartupPath + "\\Template\\QuestionSpeaking.docx";
        public static string pathTempAnswer = Application.StartupPath + "\\Temp\\";
