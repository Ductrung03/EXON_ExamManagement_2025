...
namespace EXON.SubData.Services
{
    public interface ITestNumberService
    {
        ...
        IEnumerable<TESTNUMBER> GetByContestanstshiftID(int id);
    ...
    public class TestNumberService : ITestNumberService
    {
        ...
        public TESTNUMBER GetById(int id)
        {
          ...
          public IEnumerable<TESTNUMBER> GetByContestanstshiftID(int id)
          {
               return _TestNumberRepository.GetMulti(x => x.ContestantShiftID== id);
          }
