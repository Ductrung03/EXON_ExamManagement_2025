...
namespace EXON.SubData.Services
{
    public interface IContestantTestService
    {
        ...
        CONTESTANTS_TESTS GetByContestantShiftId(int id);
          IEnumerable<CONTESTANTS_TESTS> GetAllByContestantShiftID(int ContestantShiftID);
    ...
    public class ContestantTestService : IContestantTestService
    {
        ...
        public CONTESTANTS_TESTS GetByContestantShiftId(int id)
        {
         ...
         public IEnumerable<CONTESTANTS_TESTS> GetAllByContestantShiftID(int ContestantShiftID)
          {
               return _ContestantTestRepository.GetMulti(x => x.ContestantShiftID == ContestantShiftID);
          }
     }
}